...
var dust1, dust2;
var land;
var backImg,dust1Img,dust2Img,ballImg;
//var keyCode = 0;
...
function setup() {
  ...
  world = engine.world;
  dust1 = new Dust(850, 300, 150, 100);
...
function draw() {
  ...
  image(dust2Img,850, 400, 150, 100);
 //image( ball,160,450,50,50);
 image( ballImg,160,450,50,50);
  fill(124, 9, 9);
  strokeWeight(1);
  rect(870, 400, 10, 60);
  rect(870, 460, 87, 10);
